...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		PreparedStatement ps3=con.prepareStatement("CREATE SEQUENCE Epharma1 MINVALUE 1 MAXVALUE 999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE");
		ps3.executeUpdate();
